...
const AddDoctor=({children})=>{
    ...
    return (
        <div className="column-center" style={{gap:"3em",margin:"5em 2em", padding:"5em 13em"}}>
          ...
          <div style={textColor}><h4 >Add Doctor</h4></div>
        ...
        /></div>
        <div className='row-center' style={{gap:"2.5em"}}>
          <label htmlFor="username" style={{color:"#10B3A0", padding:"20px 30px"}}>Department</label>
        <Label
          placeholderStyle="label"
          type="text"
          placeholder=""
